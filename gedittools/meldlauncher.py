...
class MeldLauncher:
    ...
    def compare(self, current_doc):
        ...
        self.builder.add_from_file( os.path.dirname( __file__ ) + "/meldlauncher.ui" )
        self._snapopen_window = self.builder.get_object("MeldLauncherWindow")
        ...
        labelbox = self.builder.get_object("labelbox")
        label = Gtk.Label()
        label.set_use_markup(True)
        label.set_markup("Compare <b>" + current_doc.get_short_name_for_display() + "</b> to ...")
        #label.set_justify(Gtk.GTK_JUSTIFY_LEFT)
